...
#PBS -o RUN_NAME.out
#PBS -j oe
#PBS -lselect=1:ncpus=64:mem=100gb
...
! Fixed time step,                     If fixed, set dt.
  fixed_time_step=.TRUE.             dt=2.0d-4
!
...
!--------------------------------------------------------------------------------------------------------------------------------
  density_phase_1                          =  998.0d0     ! Density of phase_1  (kg/m3)
...
! If ParaView,               Format,                Loop Frequency,          Time interval (s),             Prefix.
  paraview_output=.TRUE.    paraview_format="vtk"   paraview_frequency=0    paraview_time_interval='output_interval'd0   paraview_file_prefix="RUN_NAME"
!
...
! Restart Output Frequency,   Output time interval (s)      Output File Prefix.
  output_restart_frequency=0     output_restart_time_interval='output_interval'd0     output_restart_file_prefix="RUN_NAME"
!
