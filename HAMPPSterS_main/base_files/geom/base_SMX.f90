...
!
  integer,            parameter :: Nb_Drops_per_Level =   'd_per_level'          !
  integer,            parameter :: Nb_Levels          =   'n_levels'          ! 
!
  real(kind=d),dimension(Nb_Levels), parameter :: Drop_Radius = 'd_radius'
  real(kind=d),	      parameter :: Flow_Rate =   'flowrate'     ! (m^3/s)
  public ::  USER_solid, USER_bcd, USER_int
