...
log = configure_logger("sp_svgeom")
...
case = "sp_svgeom"
nruns = 18 # 50 #99
nruns_list = [str(i+464) for i in range(1, nruns + 1)] #165
...
run_path = ps.plist("run_path",["/rds/general/user/yl15517/home/BLUE-12.5.1/project/ACTIVE_LEARNING/RUNS"])
base_path = ps.plist("base_path",["/rds/general/user/yl15517/home/BLUE-12.5.1/project/ACTIVE_LEARNING/BASE"])
convert_path = ps.plist("convert_path",["/rds/general/user/yl15517/home/F_CONVERT"])
...
SV_dict = {'Impeller_Diameter (m)': [0.3*tank_diameter,0.8*tank_diameter],#[0.15,0.85]
            'Frequency (1/s)': [6,7],#[5,9] [6,9]
...
params = ps.pgrid(base_path,run_path,convert_path,case_type,local_path,save_path,
                cond_csv,conditional,vtk_conv_mode,user_ps,study_list,
