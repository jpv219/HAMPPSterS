...
case = "osc_clean"
nruns = 50
nruns_list = [str(i + 400) for i in range(1, nruns + 1)]
...
with open('../DOE/LHS_osc_clean_9.pkl', 'wb') as file:
...
with open('../params/parameters_osc_clean_9.csv', 'w', newline='') as csvfile:
