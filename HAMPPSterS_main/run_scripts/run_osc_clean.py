...
run_path = ps.plist("run_path",["/rds/general/user/knathana/home/BLUE-14.0.1/project/INT_OSC/RUNS"])
base_path = ps.plist("base_path",["/rds/general/user/knathana/home/BLUE-14.0.1/project/INT_OSC/BASE"])
convert_path = ps.plist("convert_path",["/rds/general/user/knathana/home/F_CONVERT"])
...
osc_dict = {'epsilon': [1,2.5],'Wave_number (1/m)': [1,3],'Surf_tension (N/m)': [0.1,1],'Density_l (kg/m3)': [1e-2,1],
            'Density_g (kg/m3)': [1e-3,1e-3],'Viscosity_l (Pa*s)':[1e-3,1e-2], 'Viscosity_g (Pa*s)':[6.7e-6,1e-6],'Gravity (m/s2)': [0,10]}
...
with open('../DOE/LHS_osc_clean_4.pkl', 'wb') as file:
...
with open('../params/parameters_osc_clean_4.csv', 'w', newline='') as csvfile:
