...
case = "sp_geom"
nruns = 50
nruns_list = [str(i+249) for i in range(1, nruns + 1)]
...
SMX_dict = {'Bar_Width (mm)': [1,20],'Bar_Thickness (mm)': [1,5],
            ...
            'Flowrate (m3/s)': [1e-7,1e-2],'Angle':[18,82], 'NElements': [2,8]}
...
with open('../DOE/LHS_sp_geom_9.pkl', 'wb') as file:
...
if not re_run:
    ...
    with open('../params/parameters_SP_9.csv', 'w', newline='') as csvfile:
    ...
    with open('../params/parameters_SP_9.csv', 'r') as csvfile:
