...
case = "geom"
nruns = 35
nruns_list = [str(i+65) for i in range(1, nruns + 1)]
...
with open('../DOE/LHS_geom_4.pkl', 'wb') as file:
...
if not re_run:
    ...
    with open('../params/parameters_geom_4.csv', 'w', newline='') as csvfile:
    ...
    with open('../params/parameters_geom_4.csv', 'r') as csvfile:
