...
!!!!   TANK PARAMETERS
  ...
  real(kind=d), parameter :: Interface_Level     =  0.06375_d 
!!!!   IMPELLER PARAMETERS
  real(kind=d), parameter :: BLADE_RADIUS        =   0.02125_d    !  (m)
  ...
  real(kind=d), parameter :: Clearance           =   0.01_d     !  (m)
  ...
  real(kind=d), parameter :: Impeller_Frequency  =   5.0_d
 

  public :: USER_solid, USER_int, USER_init, USER_bcd 
...
!***********************************************************************
    ...
    integer      :: i, j, k
    real(kind=d) :: Distance
     var%h%fn(:,:,:) =(surf_Gm_inf/0.025d0)*var%h%ohv(:,:,:)
